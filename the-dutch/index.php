...
<body>
  ...
  <div class="resto">
    <section class="section-header" data-toggle="sticky-onscroll">
        <nav class="navbar header-uniongroup the-dutch navbar-expand-md">
            <div class='container'>
            <img src="<?php echo $prefix;?>assets/img/uniongroup/logo/logo_thedutch.png" alt="" class='icon-header'>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 mx-auto text-center mb-3">
              <p class='title animated vp-fadeinup delayp1'> Modern gastropub serving housemade sausages, draft beers, and the capital's best live perfomances </p>
            </div>
              ...
              <div class="wrapper">
                <div class="block-location">
                  <div class="col-md-12 mb-5 animated vp-fadeinup delayp1">
                      ...
                      <span class='desc block mb-3'> 18 parc place tower e - gf scbd jakarta 12190 </span>
              ...
              <div class="col-md-12 mb-3">
                  <div class="owl-carousel owl-theme owl-img-full">
                      <div class="animated vp-fadeinright delayp3">
                          <img src="<?php echo $prefix;?>assets/img/uniongroup/slider/img_thedutch01.jpg" class='img-fluid' alt="">
                      </div>
                      <div class="animated vp-fadeinright delayp3">
                          <img src="<?php echo $prefix;?>assets/img/uniongroup/slider/img_thedutch02.jpg" class='img-fluid' alt="">
                      </div>
                      <div class="animated vp-fadeinright delayp3">
                          <img src="<?php echo $prefix;?>assets/img/uniongroup/slider/img_thedutch03.jpg" class='img-fluid' alt="">
                      </div>
                      <div class="animated vp-fadeinright delayp3">
                          <img src="<?php echo $prefix;?>assets/img/uniongroup/slider/img_thedutch04.jpg" class='img-fluid' alt="">
                      </div>
                      <div class="animated vp-fadeinright delayp3">
                          <img src="<?php echo $prefix;?>assets/img/uniongroup/slider/sample03.jpg" class='img-fluid' alt="">
                      </div>
                  </div>
              </div>
          </div>
