...
<body>
    ...
    <div class="cover" style='background: url(<?php echo $prefix;?>assets/img/uniongroup/slider/img_benedict_cover.jpg) center no-repeat; background-size: cover;'> 
    </div>
    <?php include $prefix . "include/header-slider.php";?>
    <div class="resto">
        
        <section class="section-header" data-toggle="sticky-onscroll">
            <nav class="navbar header-uniongroup navbar-expand-md" style='background: url(<?php echo $prefix;?>assets/img/uniongroup/bg/bg_navbar_benedict.jpg) center no-repeat; background-size: cover;'>
                <div class='container'>
                <img src="<?php echo $prefix;?>assets/img/uniongroup/logo/logo_benedict.png" alt="" class='icon-header'>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 text-center mx-auto mb-3">
                            <p class='title animated vp-fadeinup delayp1'>Jakarta's premier Wine Bar & Shop, boasting an inimitably cozy dining and drinking experience</p>
                        </div>
                        <div class="col-md-12 mb-3 position-relative">
                            <div class="owl-carousel owl-theme owl-location">
                                <div class="animated vp-fadeinright delayp3">
                                    <div class="wrapper">
                                        <div class="block-location">
                                            <div class="col-md-12 mb-5">
                                                <h5 class='title-location'> grand indonesia </h5>
                                                <p class='desc block mb-3'> 
                                                    east mall, lg
                                                    <br />
                                                    jl. m.h thamrin no.1 
                                                    <br />
                                                ...
                                                <a href="" class='btn-link'>map & direction</a>
                                            </div>
                                            <div class="col-md-12 mb-5">
                                ...
                                <div class="animated vp-fadeinright delayp3">
                                    <div class="wrapper">
                                        <div class="block-location">
                                            <div class="col-md-12 mb-5">
                                                <h5 class='title-location'> pasific place </h5>
                                                <p class='desc block mb-3'> 
                                                    gf unit 51c lot. 3-5-scbd 
                                                    <br />
            ...
            <section class="section-place-pict py-main">
                <div class="container place-carousel mt-5">
                    <div class="wrapper">
                        <div class="heading w-link mb-4 animated vp-fadeinup delayp1">
                            <div>
                                <h2 class='title'>what's on benedict</h2>
                            </div>
                ...
                <div class="container insta-carousel mt-5">
                    <div class="wrapper">
                        <div class="heading w-link mb-4 animated vp-fadeinup delayp1">
                            <div>
                                <h2 class='title-instagram'>@benedictjakarta</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
