...
<body>
  ...
  <div class="cover mt-5" style='background: url(<?php echo $prefix;?>assets/img/uniongroup/slider/img_king_cover.jpg) center no-repeat; background-size: cover;'> 
  </div>
      ...
      <section class="section-place-pict py-main">
          <div class="container place-carousel mt-5">
              <div class="wrapper">
                <div class="heading w-link mb-4 animated vp-fadeinup delayp1">
                    <div>
                        <h2 class='title'>what's on king</h2>
                    </div>
          ...
          <div class="container insta-carousel mt-5">
            <div class="wrapper">
              <div class="heading w-link mb-4 animated vp-fadeinup delayp1">
                  <div>
                      <h2 class='title-instagram'>@kingjkt</h2>
                  </div>
              </div>
              <div class="row">
                  <div class="col-md-12">
