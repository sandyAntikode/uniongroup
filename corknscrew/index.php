...
<body>
    ...
    <div class="cover" style='background: url(<?php echo $prefix;?>assets/img/uniongroup/slider/img_cork_screw_cover.jpg) no-repeat center; background-size: cover;'> 
    </div>
    <?php include $prefix . "include/header-slider.php";?>
    <div class="resto">

        <section class="section-header" data-toggle="sticky-onscroll">
            <nav class="navbar header-uniongroup navbar-expand-md">
                <div class='container'>
                <img src="<?php echo $prefix;?>assets/img/uniongroup/logo/logo_cork-screw.png" alt="" class='icon-header'>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 text-center mx-auto mb-3">
                            <p class='title animated vp-fadeinup delayp1'>modern gastropub serving housemade sausages, draft beers and the capital's best live performance </p>
                        </div>
                                    ...
                                    <div class="wrapper">
                                        <div class="block-location">
                                            <div class="col-md-12 mb-5">
                                                <h5 class='title-location'> plaza indonesia </h5>
                                                <span class='desc block mb-3'> first floor, unit 127 a-d</span>
                                    ...
                                    <div class="wrapper">
                                        <div class="block-location">
                                            <div class="col-md-12 mb-5">
                                                ...
                                                <span class='desc block mb-3'> tb park place tower e - gf scbd jakarta 12190 </span>
                                                <a href="" class='btn-link'>map & direction</a>
                                            </div>
                                            <div class="col-md-12 mb-5">
                                                <h5 class='title-location'> open hours </h5>
                ...
                <div class="row row-0">
                    <div class="col-md-12 mb-3">
                        <div class="owl-carousel owl-theme owl-img-full">
                            <div class="animated vp-fadeinright delayp3">
                                <img src="<?php echo $prefix;?>assets/img/uniongroup/slider/img_cork_screw01.jpg" alt="">
                            </div>
                            <div class="animated vp-fadeinright delayp3">
                                <img src="<?php echo $prefix;?>assets/img/uniongroup/slider/img_cork_screw02.jpg" alt="">
                            </div>
                            <div class="animated vp-fadeinright delayp3">
                                <img src="<?php echo $prefix;?>assets/img/uniongroup/slider/img_cork_screw03.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="section-place-pict py-main">
                <div class="container place-carousel mt-5">
                    <div class="wrapper">
                        <div class="heading w-link mb-4 animated vp-fadeinup delayp1">
                            <div>
                                <h2 class='title'>what's on cork & screw</h2>
                            </div>
                ...
                <div class="container insta-carousel mt-5">
                    <div class="wrapper">
                        <div class="heading w-link mb-4 animated vp-fadeinup delayp1">
                            <div>
                                <h2 class='title-instagram'>@corknscrewjkt</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
